...
Leap.loop(controller, function(frame){
	...
	if(plane)	{
		...
		document.getElementById("distToPlane").innerHTML = "Dot Product distance : " + dist;
		...
		document.getElementById("distFormula").innerHTML = "Distance formula: " + distFormulaValue;
